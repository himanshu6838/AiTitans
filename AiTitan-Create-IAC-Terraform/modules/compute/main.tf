/**
 * This Terraform file defines the infrastructure resources for creating virtual machines in Azure Stack.
 * It includes the definition of availability sets, network interfaces, and virtual machines.
 * 
 * Resources:
 * - azurerm_availability_set: Defines an availability set for grouping virtual machines.
 * - azurerm_network_interface: Defines a network interface for connecting virtual machines to a network.
 * - azurerm_virtual_machine: Defines a virtual machine with its associated resources.
 * 
 * Note: This file contains two sets of resources, one for web servers and another for app servers.
 */
